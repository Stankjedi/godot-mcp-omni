...
export function animationStateMachineScript(): string {
  return [
    ...
    '',
    'signal state_changed(prev_state: String, next_state: String)',
    '',
    ...
    '  _notify_animation(state)',
    '',
    'func _notify_animation(next_state: String) -> void:',
    '  if String(animation_tree_path) == "":',
    '    return',
    '  var tree := get_node_or_null(animation_tree_path) as AnimationTree',
    '  if tree == null:',
    '    return',
    '  var playback = tree.get("parameters/playback")',
    '  if playback != null and playback.has_method("travel"):',
    '    playback.travel(next_state)',
    '',
  ].join('\n');
}
